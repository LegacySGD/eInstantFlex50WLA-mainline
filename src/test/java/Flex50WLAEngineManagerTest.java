...
public class Flex50WLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Flex50WLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Flex50WLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Flex50WLAIW/InitOutcome.xml").getDocumentElement();
